...
class GeminiAutoResponderMod(loader.Module):
    ...
    def __init__(self):
        ...
        self.db = None # Hikka установит это
    ...
    async def client_ready(self):
        ...
        """
        self.db = self.get_db() # Получаем базу данных Hikka
    ...
    async def _get_formatted_history(self, chat_id: int) -> str:
        ...
        # Возвращаем историю в обратном порядке, чтобы последние сообщения были внизу
        # или в прямом порядке, как удобнее для промпта. Здесь в прямом.
